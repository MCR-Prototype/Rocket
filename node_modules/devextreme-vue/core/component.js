...
var BaseComponent = Vue.extend({
    ...
    updated: function () {
        ...
        if (this.$_config.componentsCountChanged) {
            ...
            var prevOptions_1 = this.$_config.prevNestedOptions;
            var optionsList_1 = Object.keys(options);
            var prevOptionsList = Object.keys(prevOptions_1);
            if (optionsList_1.length < prevOptionsList.length) {
                prevOptionsList.forEach(function (prevName) {
                    ...
                    if (!hasOption) {
                        var value = Array.isArray(prevOptions_1[prevName]) ? [] : {};
                        _this.$_instance.option(prevName, value);
                    }
                });
            }
